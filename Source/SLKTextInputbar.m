...
@property (nonatomic, strong) NSLayoutConstraint *leftButtonTopMarginC;
...
- (SLKTextView *)textView
{
    if (!_textView) {
        ...
        _textView.textContainerInset = UIEdgeInsetsMake(16.0, 4.0, 8.0, 0.0);
...
- (void)setAutoHideLeftButton:(BOOL)hide
{
    if (self.autoHideLeftButton == hide) {
        return;
    }
    
    _autoHideLeftButton = hide;
...
- (void)slk_setupViewConstraints
{
    ...
    self.leftButtonTopMarginC = [self slk_constraintForAttribute:NSLayoutAttributeTop firstItem:self.leftButton secondItem:self];
...
- (void)slk_updateConstraintConstants
{
    ...
    if (self.isEditing)
    {
        ...
        CGFloat leftVerMargin = (self.intrinsicContentSize.height - self.slk_contentViewHeight - self.leftButton.intrinsicContentSize.height) / 2.0;
        CGFloat leftVerBottomMargin = leftVerMargin + self.slk_contentViewHeight;
        
        self.leftButtonTopMarginC.constant = leftVerMargin;
        self.leftButtonBottomMarginC.constant = leftVerBottomMargin;
